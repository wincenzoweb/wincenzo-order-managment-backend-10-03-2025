...
// const userPaymentDataSchema = new mongoose.Schema({
//     sl: { type: Number },
//     barcode: { type: String, index: true },
//     ref: { type: String },
//     city: { type: String },
...
// userPaymentDataSchema.index({ barcode: 1, branch: 1, date: 1 })

// module.exports = mongoose.model('UserPaymentData', userPaymentDataSchema);
